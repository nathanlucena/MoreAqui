 ...
 * deal with any object that is serializable. The client DAO is not in charge of
 * opening the communication channel. Instead, it receives the in and out
 * channels from an Invoker. In this way, the users of the DAO do not have to
 * worry about closing this channel.
 * 
 * @author Fernando
 *
 */
